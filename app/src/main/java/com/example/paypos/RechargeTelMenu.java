...
public class RechargeTelMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recharge_tel_menu);
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        startActivity(i);
                        // Toast.makeText(RechargeTelMenu.this, "Home", Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
