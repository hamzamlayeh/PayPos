...
public class ConsulteSoldeMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulte_solde_menu);
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        startActivity(i);
                        //Toast.makeText(ConsulteSoldeMenu.this, "Home", Toast.LENGTH_LONG).show();
                    }
                }
        );
    }

    @OnClick(R.id.btnConsultSolde)
