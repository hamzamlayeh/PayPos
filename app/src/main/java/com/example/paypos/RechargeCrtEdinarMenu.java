...
public class RechargeCrtEdinarMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recharge_crt_edinar_menu);
    ...
    @OnClick(R.id.btnAffiliation)
    public void btnAffiliation() {
        startActivity(new Intent(getApplicationContext(), AffiliationCrtActivity.class));
    }

    @OnClick(R.id.btnRecharge)
    public void btnRecharge() {
        startActivity(new Intent(getApplicationContext(), RechargeCrtEdinarActivity.class));
    }
